      ...
      <div className="relative max-w-5xl mx-auto px-6 md:px-12 z-20 flex flex-col items-center text-center pt-20 pb-28 md:pb-36">
        ...
        >
          ...
          <a
            ...
            className="w-full sm:w-auto px-8 py-4 border border-brand-cream/30 text-brand-cream text-[10px] tracking-[0.25em] uppercase rounded-sm font-medium hover:bg-brand-cream/5 hover:border-brand-cream transition-all duration-500 flex items-center justify-center gap-2 cursor-pointer"
          >
            Conhecer Conceito
          </a>
        </div>
